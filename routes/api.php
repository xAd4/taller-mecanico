...
Route::middleware(['auth:sanctum', 'throttle:limitador_global'])->group(function () {
    ...
    Route::put('tareas/{tarea}', [TareaController::class, 'update'])->middleware([ChecarRol::class . ':' . User::ROL_JEFE . ',' . User::ROL_MECANICO ]);
    ...
    Route::post('productos-usados', [ProductoUsadoController::class, 'store'])->middleware([ChecarRol::class . ':' . User::ROL_JEFE . ',' . User::ROL_MECANICO ]);
    // Route::get('productos-usados/{productoUsado}', [ProductoUsadoController::class, 'show']);
    Route::put('productos-usados/{productoUsado}', [ProductoUsadoController::class, 'update'])->middleware([ChecarRol::class . ':' . User::ROL_JEFE . ',' . User::ROL_MECANICO ]);
    Route::delete('productos-usados/{productoUsado}', [ProductoUsadoController::class, 'destroy'])->middleware([
    ChecarRol::class . ':' . User::ROL_JEFE . ',' . User::ROL_MECANICO ]);
    ...
    Route::post('frenos', [FrenosController::class, 'store'])->middleware([
    ChecarRol::class . ':' . User::ROL_JEFE . ',' . User::ROL_MECANICO ]);
    // Route::get('frenos/{freno}', [FrenosController::class, 'show']);
    Route::put('frenos/{freno}', [FrenosController::class, 'update'])->middleware([
    ChecarRol::class . ':' . User::ROL_JEFE . ',' . User::ROL_MECANICO ]);
    Route::delete('frenos/{freno}', [FrenosController::class, 'destroy'])->middleware([
    ChecarRol::class . ':' . User::ROL_JEFE . ',' . User::ROL_MECANICO ]);

    //* Estados Neumaticos
    Route::get('estados-neumaticos', [EstadoNeumaticoController::class, 'index']);
    Route::post('estados-neumaticos', [EstadoNeumaticoController::class, 'store'])->middleware([
    ChecarRol::class . ':' . User::ROL_JEFE . ',' . User::ROL_MECANICO ]);
